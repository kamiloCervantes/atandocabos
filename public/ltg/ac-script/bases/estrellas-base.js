...
//			console.log(d);
    ...
    function tooltipBolas(e, circ) {
		...
		var tip = $(circ).closest('.lt-graf').children('.lt-tooltip-est'),
			...
			txtDin = (e.respuesta == '1' || e.respuesta == '2' || e.respuesta == '3' || e.respuesta == '4' || e.respuesta == '5' || e.respuesta == 'Muy segura' || e.respuesta == 'Muy insegura') ? 'la califican ' : 'dice ',
			infoTool = (e.vista == "edad") ? '<span class="tip-dato">El <b>' + porc + '</b></span><span class="tip-gDes">de ' + clave + ' años </span><span class="tip-rta">'+txtDin+ rta + '</span>' :
            (e.vista == "sexo") ? '<span class="tip-dato">El <b>' + porc + '</b></span><span class="tip-gDes">de sexo ' + clave + ' </span><span class="tip-rta">'+txtDin + rta + '</span>' :
            '<span class="tip-dato">El <b>' + porc + '</b></span><span class="tip-rta">'+txtDin + rta + '</span>';
