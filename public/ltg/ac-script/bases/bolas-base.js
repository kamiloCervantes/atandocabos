...
function bolasSimples(miDiv, miDato, idInd, laVista, escala, carga) {
    ...
    var centrosMap = centros.map(function(obj, i) {
        var nX = obj[0],
			...
			des = (laVista == 'edad') ? 90 : (laVista == 'sexo') ? 100 : 1;
    ...
    function tooltipBolas(e, circ) {
		var tip = $(circ).closest('.lt-graf').children('.lt-tooltip-bolas'),
            ...
            infoTool = (e.vista === "edad") ? '<span class="tip-dato">El <b>' + porc + '</b></span><span class="tip-gDes">de los de ' + clave + ' años </span><span class="tip-rta">dice que ' + rta + '</span>' :
            (e.vista === "sexo") ? '<span class="tip-dato">El <b>' + porc + '</b></span><span class="tip-gDes">de sexo ' + clave + ' </span><span class="tip-rta">dice que ' + rta + '</span>' :
            '<span class="tip-dato">El <b>' + porc + '</b></span><span class="tip-rta">dice que ' + rta + '</span>';
